...
Декоратор для логирования выполнения функций. Логирует успешные вызовы функций и ошибки с информацией о входных параметрах.

**Параметры:**
- `filename` (Optional[str]): Если указан - логи пишутся в файл. Если не указан - логи выводятся в консоль.
...
result = multiply(2, 3)
# Запись в файл app.log: "multiply ok"
```
...
divide(1, 0)
# Вывод в консоль: "divide error: ZeroDivisionError. Inputs: (1, 0), {}"
```
...
- `widget.py` - функции форматирования дат и работы с транзакциями
- `generators.py` - генераторы для обработки больших массивов данных
- `decorators/log.py` - декоратор логирования с поддержкой вывода в консоль и файл

Все тесты покрывают различные сценарии работы функций, включая успешные вызовы и обработку ошибок.
